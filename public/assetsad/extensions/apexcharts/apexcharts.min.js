					...
					[
						...
						},
						{
							...
							value: function () {
								...
								return (
									c.attr({ x: t, y: e, width: i > 0 ? i : 0, height: a > 0 ? a : 0, rx: s, ry: s, opacity: o, "stroke-width": null !== n ? n : 0, stroke: null !== l ? l : "none", "stroke-dasharray": h }), c.node.setAttribute("fill", r), c
								);
							},
						},
						{
						...
						},
						{
							...
							value: function (t) {
								...
								y &&
									(X.node.addEventListener("mouseenter", this.pathMouseEnter.bind(this, X)), X.node.addEventListener("mouseleave", this.pathMouseLeave.bind(this, X)), X.node.addEventListener("mousedown", this.pathMouseDown.bind(this, X))),
						...
						value: function (t) {
							...
							if (a && "object" === i(a)) {
								var l,
									...
									b = {};
								(b =
									-1 !== ["line", "area", "bar", "candlestick", "boxPlot", "rangeBar", "rangeArea", "bubble", "scatter", "heatmap", "treemap", "pie", "polarArea", "donut", "radar", "radialBar"].indexOf(a.chart.type)
										? r[a.chart.type]()
										: r.line()),
								...
								for (var g = 0; g < l.x.length; g++) {
									...
									if (
										...
										o.config.series[n].data[u] &&
											(o.config.series[n].data[u].fillColor && (f.pointFillColor = o.config.series[n].data[u].fillColor), o.config.series[n].data[u].strokeColor && (f.pointStrokeColor = o.config.series[n].data[u].strokeColor)),
											a && (f.pSize = a),
						...
						value: function (t) {
							...
							for (
								...
								if (
									...
									"datetime" === s.xaxis.type ? ((r.isXNumeric = !0), c(), r.seriesX.push(this.twoDSeriesX)) : "numeric" === s.xaxis.type && ((r.isXNumeric = !0), n.length > 0 && ((this.twoDSeriesX = n), r.seriesX.push(this.twoDSeriesX))),
										r.labels.push(this.twoDSeriesX);
									  ...
									  Array.isArray(i.config.colors) &&
											...
											(i.globals.colors = i.config.series.map(function (t, a) {
												...
												return (
													...
													"function" == typeof s ? ((e.isColorFn = !0), s({ value: i.globals.axisCharts ? (i.globals.series[a][0] ? i.globals.series[a][0] : 0) : i.globals.series[a], seriesIndex: a, dataPointIndex: a, w: i })) : s
												);
											}))),
						...
						value: function () {
							...
							for (var o = e.globals.legendFormatter, n = e.config.legend.inverseOrder, l = n ? a.length - 1 : 0; n ? l >= 0 : l <= a.length - 1; n ? l-- : l++) {
								...
								e.config.legend.showForNullSeries ||
									(M.isSeriesNull(l) && -1 === e.globals.collapsedSeriesIndices.indexOf(l) && -1 === e.globals.ancillaryCollapsedSeriesIndices.indexOf(l) && P.classList.add("apexcharts-hidden-null-series")),
				...
				r(t, [
					{
						...
						value: function (t) {
							...
							return (
								...
								(k = this.drawCalculatedDataLabels({ x: L.dataLabelsX, y: L.dataLabelsY, val: this.barCtx.isRangeBar ? [a, s] : h[r][o], i: n, j: o, barWidth: d, barHeight: c, textRects: z, dataLabelsConfig: P })),
				...
				r(t, [
					...
					},
					{
						...
						value: function (t) {
							...
							X.count > 0 && s >= P.globals.dataPoints - X.count && (M.node.setAttribute("stroke-dasharray", X.dashArray), M.node.setAttribute("stroke-width", X.strokeWidth), M.node.setAttribute("fill-opacity", X.fillOpacity)),
								void 0 !== u && void 0 !== p && (M.attr("data-range-y1", u), M.attr("data-range-y2", p)),
								new v(this.ctx).setSelectionFilter(M, e, s),
								c.add(M);
							var z = new vt(this).handleBarDataLabels({ x: d, y: g, y1: u, y2: p, i: r, j: s, series: f, realIndex: e, groupIndex: o, barHeight: x, barWidth: b, barXPosition: y, barYPosition: w, renderedPath: M, visibleSeries: C });
							...
							for (var h = n ? 0 : l.length - 1; n ? h < l.length : h >= 0; n ? h++ : h--) {
								...
								for (var g = 0, u = e.config.plotOptions.heatmap.shadeIntensity, p = 0; p < l[h].length; p++) {
									...
									if (
										...
										c.add(k),
										k.attr({ fill: b, i: h, index: h, j: p, val: l[h][p], "stroke-width": this.strokeWidth, stroke: e.config.plotOptions.heatmap.useFillColorAsStroke ? b : e.globals.stroke.colors[0], color: b }),
								...
								t.forEach(function (t, n) {
									...
									for (var b = 0; b < c.linePathsTo.length; b++) {
										var m = i.graphics.renderPaths(
											e(e({}, d), {}, { pathFrom: null === f ? c.linePathsFrom[b] : f, pathTo: c.linePathsTo[b], strokeWidth: Array.isArray(i.strokeWidth) ? i.strokeWidth[n] : i.strokeWidth, fill: "none", drawShadow: !1 }),
										);
										h.add(m);
					...
					value: function (t, i, a, s) {
						...
						for (var c = [], d = 0; d < t.length; d++) {
							...
							var b,
								...
								A = this.zeroY,
								S = this.zeroY;
							(A = this.lineHelpers.determineFirstPrevY({ i: d, series: t, prevY: A, lineYPosition: 0 }).prevY), u.push(A), (b = A);
							"rangeArea" === n && ((w = S = this.lineHelpers.determineFirstPrevY({ i: d, series: s, prevY: S, lineYPosition: 0 }).prevY), p.push(S));
							var C = {
									type: n,
									series: t,
									realIndex: g,
									...
									pX: v,
									pY: b,
									pathsFrom: this._calculatePathsFrom({ type: n, series: t, i: d, realIndex: g, prevX: k, prevY: A, prevY2: S }),
									linePaths: [],
									areaPaths: [],
									seriesIndex: a,
									lineYPosition: 0,
								...
								L = this._iterateOverDataPoints(e(e({}, C), {}, { iterations: "rangeArea" === n ? t[d].length - 1 : void 0, isRangeStart: !0 }));
							if ("rangeArea" === n) {
								var P = this._calculatePathsFrom({ series: s, i: d, realIndex: g, prevX: k, prevY: S }),
									I = this._iterateOverDataPoints(e(e({}, C), {}, { series: s, pY: w, pathsFrom: P, iterations: s[d].length - 1, isRangeStart: !1 }));
								(L.linePaths[0] = I.linePath + L.linePath), (L.pathFromLine = I.pathFromLine + L.pathFromLine);
							}
							this._handlePaths({ type: n, realIndex: g, i: d, paths: L }), this.elSeries.add(this.elPointsMain), this.elSeries.add(this.elDataLabelsWrap), c.push(this.elSeries);
						}
					...
					value: function (t) {
						...
						for (var X = n, z = 0; z < a; z++) {
							...
							E
								...
								: ((n = p - i[r][z + 1] / S[this.yaxisIndex] + 2 * (this.isReversed ? i[r][z + 1] / S[this.yaxisIndex] : 0)),
								  "rangeArea" === e && (X = p - w[r][z + 1] / S[this.yaxisIndex] + 2 * (this.isReversed ? w[r][z + 1] / S[this.yaxisIndex] : 0))),
								f.push(o),
								b.push(n),
								v.push(X);
							var F = this.lineHelpers.calculatePoints({ series: i, x: o, y: n, realIndex: s, i: r, j: z, prevY: C }),
								R = this._createPaths({ type: e, series: i, i: r, realIndex: s, j: z, x: o, y: n, y2: X, xArrj: f, yArrj: b, y2Arrj: v, pX: l, pY: h, linePath: L, areaPath: P, linePaths: d, areaPaths: g, seriesIndex: u, isRangeStart: y });
							(g = R.areaPaths),
								(d = R.linePaths),
								(l = R.pX),
								(h = R.pY),
								(P = R.areaPath),
								(L = R.linePath),
								!this.appendPathFrom || ("monotoneCubic" === k.config.stroke.curve && "rangeArea" === e) || ((I += A.line(o, this.zeroY)), (T += A.line(o, this.zeroY))),
								this.handleNullDataPoints(i, F, r, z, s),
								this._handleMarkersAndLabels({ type: e, pointsPos: F, i: r, j: z, realIndex: s, isRangeStart: y });
						}
				...
				},
				{
					...
					value: function (t) {
						var e = t.type,
							...
							S = this.areaBottomY;
						if (
							(Array.isArray(w.config.stroke.curve) && (A = Array.isArray(v) ? w.config.stroke.curve[v[a]] : w.config.stroke.curve[a]),
							(("rangeArea" === e && (w.globals.hasNullValues || w.config.forecastDataPoints.count > 0)) || w.globals.hasNullValues) && "monotoneCubic" === A && (A = "straight"),
							"smooth" === A)
						) {
							var C = 0.35 * (o - g);
							w.globals.hasNullValues
								? (null !== i[a][r] &&
										(null !== i[a][r + 1]
											? ((p = k.move(g, u) + k.curve(g + C, u, o - C, n, o + 1, n)), (f = k.move(g + 1, u) + k.curve(g + C, u, o - C, n, o + 1, n) + k.line(o, S) + k.line(g, S) + "z"))
								...
								(g = o),
								(u = n),
								r === i[a].length - 2 && ((f += k.curve(g, u, o, n, o, S) + k.move(o, n) + "z"), "rangeArea" === e && y ? (p += k.curve(g, u, o, n, o, c) + k.move(o, c) + "z") : w.globals.hasNullValues || (x.push(p), b.push(f)));
							...
							null === i[a][r] && ((p += k.move(o, n)), (f += k.move(o, S))),
								"stepline" === A ? ((p = p + k.line(o, null, "H") + k.line(null, n, "V")), (f = f + k.line(o, null, "H") + k.line(null, n, "V"))) : "straight" === A && ((p += k.line(o, n)), (f += k.line(o, n))),
								r === i[a].length - 2 && ((f = f + k.line(o, S) + k.move(o, n) + "z"), "rangeArea" === e && y ? (p = p + k.line(o, c) + k.move(o, c) + "z") : (x.push(p), b.push(f)));
						}
					...
					},
					{
						...
						value: function (t, i) {
							...
							return e(
								e({}, a.config.series[i]),
								{},
								{ name: t.name ? t.name : s && s.name, color: t.color ? t.color : s && s.color, type: t.type ? t.type : s && s.type, group: t.group ? t.group : s && s.group, data: t.data ? t.data : s && s.data },
							);
						},
					},
					{
				...
				switch (t[0]) {
					...
					case "A":
						(e = (function (t, e) {
							...
							for (b[0][0] = b[0][1].clone(), b[b.length - 1][2] = b[b.length - 1][1].clone(), s = new SVG.Matrix().rotate(M).scale(I, T).rotate(-M), k = 0, A = b.length; k < A; k++)
