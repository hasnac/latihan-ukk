...
*/ (function () {
				...
				"./node_modules/core-js/internals/iterators-core.js": function (s, f, r) {
					var l = r("./node_modules/core-js/internals/object-get-prototype-of.js"),
						...
						_,
						v;
					[].keys && ((v = [].keys()), "next" in v ? ((_ = l(l(v))), _ !== Object.prototype && (A = _)) : (m = !0)), A == null && (A = {}), !h && !u(A, g) && a(A, g, E), (s.exports = { IteratorPrototype: A, BUGGY_SAFARI_ITERATORS: m });
				},
	 ...
	 */ (function (Q, z) {
		(function (s, f) {
			...
			function Qo(n) {
				...
				e.modifiersData.popperOffsets != null && (e.styles.popper = Object.assign({}, e.styles.popper, xi(Object.assign({}, M, { offsets: e.modifiersData.popperOffsets, position: e.options.strategy, adaptive: d, roundOffsets: b })))),
			...
			function ns(n, e) {
				...
				return (
					(t.top = t.top + n.clientTop), (t.left = t.left + n.clientLeft), (t.bottom = t.top + n.clientHeight), (t.right = t.left + n.clientWidth), (t.width = n.clientWidth), (t.height = n.clientHeight), (t.x = t.left), (t.y = t.top), t
				);
			}
			function bi(n, e, t) {
			...
			class fe extends he {
				...
				_getPopperConfig() {
					...
					return (this._inNavbar || this._config.display === "static") && (be.setDataAttribute(this._menu, "popper", "static"), (e.modifiers = [{ name: "applyStyles", enabled: !1 }])), { ...e, ...H(this._config.popperConfig, [e]) };
				}
			...
			class ke extends he {
				...
				_getTemplateFactory(e) {
					return this._templateFactory ? this._templateFactory.changeContent(e) : (this._templateFactory = new Ua({ ...this._config, content: e, extraClass: this._resolvePossibleFunction(this._config.customClass) })), this._templateFactory;
				}
