...
<html lang="en">
	<head>
        ...
        <link rel="stylesheet" href="{{ asset('assetsad/compiled/css/app-dark.css') }}">
        <link rel="stylesheet" href="{{ asset('assetsad/compiled/css/iconly.css') }}">
	</head>

	<body>
		
		<div id="app">
            @include('partial_ad.navbar')
			@include('partial_ad.sidebar')
			<div id="main">
				
				@yield('content')

				@include('partial_ad.footer')
			</div>
		</div>
        @yield('script')
